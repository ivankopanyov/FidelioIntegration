...
public partial class ExpReservations
{
    ...
    public DateTime? AccompanyingBirthday1 { get; set; }
    public DateTime? AccompanyingBirthday2 { get; set; }
    ...
    public DateTime? PcMemberCardExpy { get; set; }
    public DateTime? SccMemberCardExpy { get; set; }
    ...
    public string? PcMemberCardNo { get; set; }
    public string? PcMemberCardLevel { get; set; }
    public string? SccMemberCardNo { get; set; }
    public string? SccMemberCardLevel { get; set; }
    public string? PurposeOfStay { get; set; }
    public string? RoomClass { get; set; }
    public string? CompanyState { get; set; }
    public string? CompanyPostalCode { get; set; }
    public string? CompanyCountry { get; set; }
    public string? Sharer1 { get; set; }
    public string? Sharer2 { get; set; }
    public string? Sharer3 { get; set; }
    ...
    public string? SourceIataNo { get; set; }
    ...
    public string? BusinessRewardsMembership { get; set; }
    ...
    public string? Xaddress4 { get; set; }
    public string? Xcity { get; set; }
    public string? Xstate { get; set; }
    public string? XzipCode { get; set; }
    public string? Xcountry { get; set; }
    public string? Xprovince { get; set; }
    public string? InternationalId { get; set; }
    public string? PassportId { get; set; }
    public decimal? AltAddressId { get; set; }

	public static void OnModelCreating(ModelBuilder modelBuilder, ISet<Type> types)
	{
		modelBuilder.Entity<ExpReservations>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("EXP_RESERVATIONS");

            entity.Property(e => e.AccompanyingBirthday1)
                .HasColumnName("ACCOMPANYING_BIRTHDAY_1")
                .HasColumnType("DATE")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.AccompanyingBirthday2)
                .HasColumnName("ACCOMPANYING_BIRTHDAY_2")
                .HasColumnType("DATE")
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.AltAddressId)
            ...
            entity.Property(e => e.BusinessRewardsMembership)
                .HasColumnName("BUSINESS_REWARDS_MEMBERSHIP")
                .HasMaxLength(200)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.CheckInRate)
                .HasColumnName("CHECK_IN_RATE")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.PcMemberCardExpy)
                .HasColumnName("PC_MEMBER_CARD_EXPY")
                .HasColumnType("DATE")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.PcMemberCardLevel)
                .HasColumnName("PC_MEMBER_CARD_LEVEL")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.PcMemberCardNo)
                .HasColumnName("PC_MEMBER_CARD_NO")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.SccMemberCardExpy)
                .HasColumnName("SCC_MEMBER_CARD_EXPY")
                .HasColumnType("DATE")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.SccMemberCardLevel)
                .HasColumnName("SCC_MEMBER_CARD_LEVEL")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.SccMemberCardNo)
                .HasColumnName("SCC_MEMBER_CARD_NO")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.Sharer1)
                .HasColumnName("SHARER1")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.Sharer2)
                .HasColumnName("SHARER2")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.Sharer3)
                .HasColumnName("SHARER3")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.SourceIataNo)
                .HasColumnName("SOURCE_IATA_NO")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.Xaddress3)
                .HasColumnName("XADDRESS3")
                .HasMaxLength(200)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.Xaddress4)
                .HasColumnName("XADDRESS4")
                .HasMaxLength(200)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.Xprovince)
                .HasColumnName("XPROVINCE")
                .HasMaxLength(200)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.XzipCode)
                .HasColumnName("XZIP_CODE")
                .HasMaxLength(200)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
        });
