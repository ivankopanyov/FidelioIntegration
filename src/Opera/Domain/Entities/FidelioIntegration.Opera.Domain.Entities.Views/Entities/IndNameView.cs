...
public partial class IndNameView
{
    ...
    public string? SaveInHistory { get; set; }
	...
	{
		modelBuilder.Entity<IndNameView>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("IND_NAME_VIEW");
            ...
            entity.Property(e => e.SaveInHistory)
                .HasColumnName("SAVE_IN_HISTORY")
                .HasMaxLength(1)
                .IsUnicode(false);
