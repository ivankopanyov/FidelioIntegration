...
public partial class BookingBrowse
{
    ...
    public decimal? NetRmsBlocked { get; set; }
    public decimal? NetRevBlocked { get; set; }
    public decimal? NetAvgRate { get; set; }
    public decimal? GrossRevBlocked { get; set; }
    public decimal? GrossAvgRate { get; set; }
    public decimal? FoodRevenue { get; set; }
    public decimal? OtherRevenue { get; set; }
    public decimal? NonRevenue { get; set; }
    public decimal? ActualRoomsRevenue { get; set; }
    public decimal? ActualFoodRevenue { get; set; }
	...
	{
		modelBuilder.Entity<BookingBrowse>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("BOOKING_BROWSE");

            entity.Property(e => e.ActualAvgRate)
                .HasColumnName("ACTUAL_AVG_RATE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.ActualFoodRevenue)
                .HasColumnName("ACTUAL_FOOD_REVENUE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.ActualGrossRevenue)
                .HasColumnName("ACTUAL_GROSS_REVENUE")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.ActualRoomsRevenue)
                .HasColumnName("ACTUAL_ROOMS_REVENUE")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.GrossAvgRate)
                .HasColumnName("GROSS_AVG_RATE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.GrossRevBlocked)
                .HasColumnName("GROSS_REV_BLOCKED")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.NetAvgRate)
                .HasColumnName("NET_AVG_RATE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.NetRevBlocked)
                .HasColumnName("NET_REV_BLOCKED")
                .HasColumnType("NUMBER");

            entity.Property(e => e.NetRmsBlocked)
                .HasColumnName("NET_RMS_BLOCKED")
                .HasColumnType("NUMBER");
