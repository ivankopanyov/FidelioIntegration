...
public partial class OvosContractsView
{
	...
	{
		modelBuilder.Entity<OvosContractsView>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("OVOS_CONTRACTS_VIEW");

            entity.Property(e => e.AccNameId)
                .HasColumnName("ACC_NAME_ID")
                .HasColumnType("NUMBER");

            entity.Property(e => e.AccResort)
                .HasColumnName("ACC_RESORT")
                .HasMaxLength(20)
                .IsUnicode(false);
            ...
            entity.Property(e => e.OwnerAddressId)
                .HasColumnName("OWNER_ADDRESS_ID")
                .HasColumnType("NUMBER");

            entity.Property(e => e.OwnerContractId)
                .HasColumnName("OWNER_CONTRACT_ID")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.OwnerResortId)
                .IsRequired()
                .HasColumnName("OWNER_RESORT_ID")
                .HasMaxLength(20)
                .IsUnicode(false);
            ...
            entity.Property(e => e.OwnerRoomCategoryLabel)
                .HasColumnName("OWNER_ROOM_CATEGORY_LABEL")
                .IsUnicode(false);
