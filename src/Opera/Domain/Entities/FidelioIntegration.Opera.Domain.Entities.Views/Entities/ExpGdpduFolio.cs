...
public partial class ExpGdpduFolio
{
	...
	{
		modelBuilder.Entity<ExpGdpduFolio>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("EXP_GDPDU_FOLIO");
            ...
            entity.Property(e => e.PayeeMiddleName)
                .HasColumnName("PAYEE_MIDDLE_NAME")
                .HasMaxLength(40)
                .IsUnicode(false);

            entity.Property(e => e.PayeeName2)
                .HasColumnName("PAYEE_NAME_2")
                .HasMaxLength(80)
                .IsUnicode(false);

            entity.Property(e => e.PayeeName3)
                .HasColumnName("PAYEE_NAME_3")
                .HasMaxLength(80)
                .IsUnicode(false);
            ...
            entity.Property(e => e.TrxAmountGross)
                .HasColumnName("TRX_AMOUNT_GROSS")
                .HasColumnType("NUMBER");

            entity.Property(e => e.TrxAmountNet)
                .HasColumnName("TRX_AMOUNT_NET")
                .HasColumnType("NUMBER");

            entity.Property(e => e.TrxAmountTax)
                .HasColumnName("TRX_AMOUNT_TAX")
                .HasColumnType("NUMBER");
