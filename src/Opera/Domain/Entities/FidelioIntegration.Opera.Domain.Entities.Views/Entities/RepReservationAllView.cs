...
public partial class RepReservationAllView
{
    ...
    public string? ShowAwardsLampYn { get; set; }
    public string? CreditCardNumberShort { get; set; }
    public string? IsShared3Yn { get; set; }

	public static void OnModelCreating(ModelBuilder modelBuilder, ISet<Type> types)
	{
		modelBuilder.Entity<RepReservationAllView>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("REP_RESERVATION_ALL_VIEW");
            ...
            entity.Property(e => e.AuthorizerName)
            ...
            entity.Property(e => e.CTSGName)
                .HasColumnName("C_T_S_G_NAME")
                .IsUnicode(false);
            ...
            entity.Property(e => e.CreditCardNumberShort)
                .HasColumnName("CREDIT_CARD_NUMBER_SHORT")
                .IsUnicode(false);
            ...
            entity.Property(e => e.GuestPreferencesOnly)
                .HasColumnName("GUEST_PREFERENCES_ONLY")
                .IsUnicode(false);
            ...
            entity.Property(e => e.IsShared3Yn)
                .HasColumnName("IS_SHARED_3_YN")
                .IsUnicode(false);
            ...
            entity.Property(e => e.ResvCity)
                .HasColumnName("RESV_CITY")
                .IsUnicode(false);

            entity.Property(e => e.ResvColor)
                .HasColumnName("RESV_COLOR")
                .IsUnicode(false);
            ...
            entity.Property(e => e.ShowAwardsLampYn)
                .HasColumnName("SHOW_AWARDS_LAMP_YN")
                .IsUnicode(false);
