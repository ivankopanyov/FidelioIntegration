...
public partial class RepBeoBooking
{
    ...
    public string? CatStatusShort { get; set; }
    ...
    public string? ContractScn { get; set; }
    public decimal? TaxAmount { get; set; }
    public decimal? ServiceCharge { get; set; }
    public string? AllotmentCode { get; set; }
    public string? BreakfastInclude { get; set; }
    public decimal? BreakfastPrice { get; set; }
    public string? BreakfastDesc { get; set; }
    public string? PorterageInclude { get; set; }
    ...
    public string? CateringOnly { get; set; }
    ...
    public string? BookNoteTitle { get; set; }
    public string? BookNoteInternal { get; set; }
	...
	{
		modelBuilder.Entity<RepBeoBooking>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("REP_BEO_BOOKING");
            ...
            entity.Property(e => e.BookNoteInternal)
                .HasColumnName("BOOK_NOTE_INTERNAL")
                .HasMaxLength(1)
                .IsUnicode(false);

            entity.Property(e => e.BookNoteTitle)
                .HasColumnName("BOOK_NOTE_TITLE")
                .HasMaxLength(200)
                .IsUnicode(false);

            entity.Property(e => e.BookNotes)
                .HasColumnName("BOOK_NOTES")
                .HasMaxLength(2000)
                .IsUnicode(false);

            entity.Property(e => e.BookOwner)
                .HasColumnName("BOOK_OWNER")
                .IsUnicode(false);
            ...
            entity.Property(e => e.BookingtypeDesc)
                .HasColumnName("BOOKINGTYPE_DESC")
                .IsUnicode(false);

            entity.Property(e => e.BreakfastDesc)
                .HasColumnName("BREAKFAST_DESC")
                .HasMaxLength(40)
                .IsUnicode(false);

            entity.Property(e => e.BreakfastInclude)
                .HasColumnName("BREAKFAST_INCLUDE")
                .HasMaxLength(1)
                .IsUnicode(false);

            entity.Property(e => e.BreakfastPrice)
                .HasColumnName("BREAKFAST_PRICE")
            ...
            entity.Property(e => e.CatStatusShort)
                .HasColumnName("CAT_STATUS_SHORT")
                .HasMaxLength(20)
                .IsUnicode(false);
            ...
            entity.Property(e => e.CateringOnly)
                .HasColumnName("CATERING_ONLY")
                .HasMaxLength(1)
                .IsUnicode(false);
            ...
            entity.Property(e => e.ContractScn)
                .HasColumnName("CONTRACT_SCN")
                .HasMaxLength(40)
                .IsUnicode(false);
            ...
            entity.Property(e => e.PorterageInclude)
                .HasColumnName("PORTERAGE_INCLUDE")
                .HasMaxLength(1)
                .IsUnicode(false);
            ...
            entity.Property(e => e.XcontactName)
                .HasColumnName("XCONTACT_NAME")
                .HasMaxLength(81)
                .IsUnicode(false);
