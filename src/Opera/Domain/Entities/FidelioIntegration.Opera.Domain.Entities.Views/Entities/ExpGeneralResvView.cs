...
public partial class ExpGeneralResvView
{
    ...
    public decimal? InstAwardAmount { get; set; }
    public string? TotalEligibleAwardRedeem { get; set; }
    public string? TotalEligibleCreditEarn { get; set; }

	public static void OnModelCreating(ModelBuilder modelBuilder, ISet<Type> types)
	{
		modelBuilder.Entity<ExpGeneralResvView>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("EXP_GENERAL_RESV_VIEW");
