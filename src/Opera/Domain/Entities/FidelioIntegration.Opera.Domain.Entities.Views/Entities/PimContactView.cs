...
public partial class PimContactView
{
	...
	{
		modelBuilder.Entity<PimContactView>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("PIM_CONTACT_VIEW");
            ...
            entity.Property(e => e.Businessaddressstreet)
            ...
            entity.Property(e => e.Gennotes)
                .HasColumnName("GENNOTES")
                .IsUnicode(false);

            entity.Property(e => e.Gennotestitle)
                .HasColumnName("GENNOTESTITLE")
                .IsUnicode(false);
            ...
            entity.Property(e => e.HomeAddressstreet)
                .HasColumnName("HOME_ADDRESSSTREET")
                .IsUnicode(false);
            ...
            entity.Property(e => e.HomeCityExt)
                .HasColumnName("HOME_CITY_EXT")
                .IsUnicode(false);

            entity.Property(e => e.HomeCountryName)
                .HasColumnName("HOME_COUNTRY_NAME")
                .IsUnicode(false);

            entity.Property(e => e.HomeFaxNumber)
                .HasColumnName("HOME_FAX_NUMBER")
                .IsUnicode(false);
            ...
            entity.Property(e => e.OtherAddress1)
                .HasColumnName("OTHER_ADDRESS1")
                .IsUnicode(false);

            entity.Property(e => e.OtherAddress2)
                .HasColumnName("OTHER_ADDRESS2")
                .IsUnicode(false);

            entity.Property(e => e.OtherAddressId)
                .HasColumnName("OTHER_ADDRESS_ID")
                .HasColumnType("NUMBER");

            entity.Property(e => e.OtherAddressstreet)
                .HasColumnName("OTHER_ADDRESSSTREET")
                .IsUnicode(false);
            ...
            entity.Property(e => e.OtherCityExt)
                .HasColumnName("OTHER_CITY_EXT")
                .IsUnicode(false);

            entity.Property(e => e.OtherCountryName)
                .HasColumnName("OTHER_COUNTRY_NAME")
                .IsUnicode(false);

            entity.Property(e => e.OtherFaxNumber)
                .HasColumnName("OTHER_FAX_NUMBER")
                .IsUnicode(false);

            entity.Property(e => e.OtherPhoneNumber)
                .HasColumnName("OTHER_PHONE_NUMBER")
                .IsUnicode(false);
            ...
            entity.Property(e => e.OtherZipCode)
                .HasColumnName("OTHER_ZIP_CODE")
                .IsUnicode(false);
