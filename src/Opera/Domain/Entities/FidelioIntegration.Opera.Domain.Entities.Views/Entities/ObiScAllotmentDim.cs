...
public partial class ObiScAllotmentDim
{
    ...
    public string? OffsetTypeStr { get; set; }
    public DateTime? OriginalBeginDate { get; set; }
    public DateTime? OriginalEndDate { get; set; }
    public decimal? PrimaryAccountId { get; set; }
    public decimal? PrimaryContactId { get; set; }
	...
	{
		modelBuilder.Entity<ObiScAllotmentDim>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("OBI_SC_ALLOTMENT_DIM");
            ...
            entity.Property(e => e.OffsetTypeStr)
                .HasColumnName("OFFSET_TYPE_STR")
                .HasMaxLength(200)
                .IsUnicode(false);
            ...
            entity.Property(e => e.PrimaryAccountId)
