...
public partial class ContractBrowse
{
    ...
    public decimal? LyActFbRevenue { get; set; }
    public decimal? LyActOtherRevenue { get; set; }
    public decimal? Ly1ActRoomNights { get; set; }
    public decimal? Ly1ActRoomRevenue { get; set; }
	...
	{
		modelBuilder.Entity<ContractBrowse>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("CONTRACT_BROWSE");
            ...
            entity.Property(e => e.ContractOwnerFullName)
                .HasColumnName("CONTRACT_OWNER_FULL_NAME")
                .HasMaxLength(122)
                .IsUnicode(false);

            entity.Property(e => e.ContractStatusDescription)
            ...
            entity.Property(e => e.Ly1ActAvgRoomRate)
                .HasColumnName("LY1_ACT_AVG_ROOM_RATE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.Ly1ActFbRevenue)
                .HasColumnName("LY1_ACT_FB_REVENUE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.Ly1ActOtherRevenue)
                .HasColumnName("LY1_ACT_OTHER_REVENUE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.Ly1ActRoomNights)
                .HasColumnName("LY1_ACT_ROOM_NIGHTS")
                .HasColumnType("NUMBER");

            entity.Property(e => e.Ly1ActRoomRevenue)
                .HasColumnName("LY1_ACT_ROOM_REVENUE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.LyActAvgRoomRate)
                .HasColumnName("LY_ACT_AVG_ROOM_RATE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.LyActFbRevenue)
                .HasColumnName("LY_ACT_FB_REVENUE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.LyActOtherRevenue)
                .HasColumnName("LY_ACT_OTHER_REVENUE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.LyActRoomNights)
                .HasColumnName("LY_ACT_ROOM_NIGHTS")
                .HasColumnType("NUMBER");

            entity.Property(e => e.LyActRoomRevenue)
                .HasColumnName("LY_ACT_ROOM_REVENUE")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.PotAvgRoomRate)
                .HasColumnName("POT_AVG_ROOM_RATE")
                .HasColumnType("NUMBER");
