...
public partial class ExpDbstay
{
    ...
    public string? TravelAgentContactName { get; set; }
    ...
    public string? TravelAgentState { get; set; }
    public string? TravelAgentPostalCode { get; set; }
    public string? TravelAgentCountry { get; set; }
    public string? TravelAgentTelephone { get; set; }
    public string? TravelAgentFax { get; set; }
    ...
    public string? GuestIataCorpNo { get; set; }
    public string? WalkinFlag { get; set; }
    public decimal? CheckinUser { get; set; }
    public decimal? CheckoutUser { get; set; }
    public decimal? GpEligibleRevenue { get; set; }
    public decimal? GpEligibleNights { get; set; }
    public string? GpEligibleRevenueYn { get; set; }
	...
	{
		modelBuilder.Entity<ExpDbstay>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("EXP_DBSTAY");
            ...
            entity.Property(e => e.CheckinUser)
                .HasColumnName("CHECKIN_USER")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.CheckoutUser)
                .HasColumnName("CHECKOUT_USER")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.GpEligibleNights)
                .HasColumnName("GP_ELIGIBLE_NIGHTS")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.GpEligibleRevenue)
                .HasColumnName("GP_ELIGIBLE_REVENUE")
                .HasColumnType("NUMBER")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.GpEligibleRevenueYn)
                .HasColumnName("GP_ELIGIBLE_REVENUE_YN")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.GuestIataCorpNo)
                .HasColumnName("GUEST_IATA_CORP_NO")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.TravelAgentContactName)
                .HasColumnName("TRAVEL_AGENT_CONTACT_NAME")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.TravelAgentCountry)
                .HasColumnName("TRAVEL_AGENT_COUNTRY")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.TravelAgentFax)
                .HasColumnName("TRAVEL_AGENT_FAX")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.TravelAgentState)
                .HasColumnName("TRAVEL_AGENT_STATE")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.TravelAgentTelephone)
                .HasColumnName("TRAVEL_AGENT_TELEPHONE")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.WalkinFlag)
                .HasColumnName("WALKIN_FLAG")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
        });
