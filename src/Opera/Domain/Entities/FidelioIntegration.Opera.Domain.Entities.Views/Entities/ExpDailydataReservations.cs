...
public partial class ExpDailydataReservations
{
    ...
    public string? ReservationPaymentCode { get; set; }
    ...
    public string? ResvCreditCardNo { get; set; }
    public DateTime? ResvCreditCardExpy { get; set; }
    ...
    public string? ExportResStatus { get; set; }
    ...
    public string? XnameCounter { get; set; }
    public string? Xlanguage { get; set; }
    public decimal? UpsellCharge { get; set; }

	public static void OnModelCreating(ModelBuilder modelBuilder, ISet<Type> types)
	{
		modelBuilder.Entity<ExpDailydataReservations>(entity =>
        {
            entity.HasNoKey();

            entity.ToView("EXP_DAILYDATA_RESERVATIONS");

            entity.Property(e => e.AccSeq)
                .HasColumnName("ACC_SEQ")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.ExportResStatus)
                .HasColumnName("EXPORT_RES_STATUS")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.GroupContactName)
                .HasColumnName("GROUP_CONTACT_NAME")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.PreviousRoom)
                .HasColumnName("PREVIOUS_ROOM")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.ReservationPaymentCode)
                .HasColumnName("RESERVATION_PAYMENT_CODE")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.ResvCreditCardExpy)
                .HasColumnName("RESV_CREDIT_CARD_EXPY")
                .HasColumnType("DATE")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.ResvCreditCardNo)
                .HasColumnName("RESV_CREDIT_CARD_NO")
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.XnameCounter)
                .HasColumnName("XNAME_COUNTER")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
        });
