...
public partial class NameView
{
    ...
    public decimal? TotalCancelRes { get; set; }
    public decimal? TotalFBRevenue { get; set; }
    public decimal? TotalNonRevenue { get; set; }
    public decimal? TotalOtherRevenue { get; set; }
    public decimal? TotalNoShowRes { get; set; }
    public decimal? TotalResArrivals { get; set; }
    public decimal? TotalResNights { get; set; }
    public decimal? TotalRoomRevenue { get; set; }
    public decimal? TotalResDayUse { get; set; }
    public decimal? TotalCancelResLastyr { get; set; }
    public decimal? TotalFBRevenueLastyr { get; set; }
    public decimal? TotalNonRevenueLastyr { get; set; }
    public decimal? TotalOtherRevenueLastyr { get; set; }
    public decimal? TotalNoShowResLastyr { get; set; }
    public decimal? TotalResArrivalsLastyr { get; set; }
    public decimal? TotalResNightsLastyr { get; set; }
    public decimal? TotalRoomRevenueLastyr { get; set; }
    public decimal? TotalResDayUseLastyr { get; set; }
    public string? AddrCleansedStatus { get; set; }
    public DateTime? AddrCleansedDatetime { get; set; }
    public string? AddrCleansedErrormsg { get; set; }
    public string? AddrCleansedValstatus { get; set; }
    ...
    public string? IndexPassport { get; set; }
	...
	public static void OnModelCreating(ModelBuilder modelBuilder, ISet<Type> types)
	{
		modelBuilder.Entity<NameView>(entity =>
        {
            ...
            entity.Property(e => e.AddrCleansedDatetime)
                .HasColumnName("ADDR_CLEANSED_DATETIME")
                .HasColumnType("DATE")
                .ValueGeneratedOnAdd();

            entity.Property(e => e.AddrCleansedErrormsg)
                .HasColumnName("ADDR_CLEANSED_ERRORMSG")
                .HasMaxLength(2000)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.AddrCleansedStatus)
                .HasColumnName("ADDR_CLEANSED_STATUS")
                .HasMaxLength(1)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();

            entity.Property(e => e.AddrCleansedValstatus)
                .HasColumnName("ADDR_CLEANSED_VALSTATUS")
                .HasMaxLength(100)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.EncryptedBirthDate)
                .HasColumnName("ENCRYPTED_BIRTH_DATE")
                .HasMaxLength(80)
                .IsUnicode(false)
                .ValueGeneratedOnAdd();
            ...
            entity.Property(e => e.IndexPassport)
                .HasColumnName("INDEX_PASSPORT")
                .HasMaxLength(200)
                .IsUnicode(false);
            ...
            entity.Property(e => e.TotalCancelRes)
                .HasColumnName("TOTAL_CANCEL_RES")
                .HasColumnType("NUMBER");

            entity.Property(e => e.TotalCancelResLastyr)
                .HasColumnName("TOTAL_CANCEL_RES_LASTYR")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.TotalFBRevenueLastyr)
                .HasColumnName("TOTAL_F_B_REVENUE_LASTYR")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.TotalNoShowRes)
                .HasColumnName("TOTAL_NO_SHOW_RES")
                .HasColumnType("NUMBER");

            entity.Property(e => e.TotalNoShowResLastyr)
                .HasColumnName("TOTAL_NO_SHOW_RES_LASTYR")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.TotalNonRevenueLastyr)
                .HasColumnName("TOTAL_NON_REVENUE_LASTYR")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.TotalOtherRevenueLastyr)
                .HasColumnName("TOTAL_OTHER_REVENUE_LASTYR")
                .HasColumnType("NUMBER");

            entity.Property(e => e.TotalResArrivals)
                .HasColumnName("TOTAL_RES_ARRIVALS")
                .HasColumnType("NUMBER");

            entity.Property(e => e.TotalResArrivalsLastyr)
                .HasColumnName("TOTAL_RES_ARRIVALS_LASTYR")
                .HasColumnType("NUMBER");

            entity.Property(e => e.TotalResDayUse)
                .HasColumnName("TOTAL_RES_DAY_USE")
                .HasColumnType("NUMBER");

            entity.Property(e => e.TotalResDayUseLastyr)
                .HasColumnName("TOTAL_RES_DAY_USE_LASTYR")
                .HasColumnType("NUMBER");

            entity.Property(e => e.TotalResNights)
                .HasColumnName("TOTAL_RES_NIGHTS")
                .HasColumnType("NUMBER");

            entity.Property(e => e.TotalResNightsLastyr)
                .HasColumnName("TOTAL_RES_NIGHTS_LASTYR")
                .HasColumnType("NUMBER");
            ...
            entity.Property(e => e.TotalRoomRevenueLastyr)
                .HasColumnName("TOTAL_ROOM_REVENUE_LASTYR")
                .HasColumnType("NUMBER");
